...
import { Save, Upload, Plus, Trash2, X, FileText, CheckCircle } from 'lucide-react';
import { ProjectData } from '../types';

const AdminPanel: React.FC<{ onClose: () => void }> = ({ onClose }) => {
  const { projects, updateProject, addProject, deleteProject, uploadPitchDeck } = useData();
  const { user } = useAuth();
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="flex justify-between items-center mb-8">
          <div>
            ...
            <p className="text-slate-500 dark:text-slate-400">Manage pitch decks and project data</p>
          </div>
